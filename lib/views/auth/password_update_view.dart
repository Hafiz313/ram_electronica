...
class PasswordUpdateView extends StatefulWidget {
  ...
  static const String routeName = '/passwordUpdateView';
...
class _PasswordUpdateViewState extends State<PasswordUpdateView> {
  ...
  void startTwoSecondTimer() {
    ...
    // Start a timer that runs for 2 seconds
    Timer(const Duration(seconds: 2), () {
      setState(() {
        _isTimerRunning = false;  // Timer has completed after 2 seconds
      });
      // You can add any additional logic here, such as navigating or showing a message
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                headline2('${Lang.password} ${Lang.update}'),
                SizedBox(
                  height: context.percentHeight * 1.0,
                ),
                subText3(Lang.updatePasswordMsg)
