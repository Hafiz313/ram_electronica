...
class DisputeView extends StatelessWidget {
  DisputeView({Key? key}) : super(key: key);

  static const String routeName = '/DisputeView';
              ...
              children: [
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          headline2(Lang.dispute,color: AppColors.textColor),
                    ...
                    Column(
                      children: [
                        textFiled(context, title: Lang.emailAddress, hintText: Lang.email, textEditingController: passwordTxtField),
                        SizedBox(
                          height: context.percentHeight * 2.0,
                        ),
                        textFiled(context, title:Lang.description, hintText: Lang.description, textEditingController: newPasswordTxtField)
                  ...
                  child: Container(
                    ...
                    child: AppElevatedButton(
                      onPressed: () async {
                        ...
                        navigate.currentState?.pushNamed(SubmitView.routeName);
